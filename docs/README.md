...
⚠️*The Working Directory will be AscendAI/GremlinGPT, His tools are Architeched(MB-MM is one of them, debugging finishes when integration into GremlinGPT is needed). Time to Debug, Lets Scare the .orgs*⚠️
